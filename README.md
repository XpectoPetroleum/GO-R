...
**Use the full set of over 1300 patches (sounds) for your Roland GO: series piano/keyboard!**

It's a lightweight, full-screen MIDI patch selector and sender for **Roland GO: series** keyboards (GO:PIANO, GO:KEYS). Built with **Pygame** for a clean, responsive UI that's especially suited for small touchscreens or gamepad controls on retro handhelds. 
...
- Use the full set of over 1300 patches (sounds)!
...
If you found this, or any other of my projects useful, please consider a donation to support the development!  
